...
public class FieldTestPaginationEntity implements Serializable {
    ...
    @Lob
    @Column(name = "byte_image_required_alice")
    private byte[] byteImageRequiredAlice;

    @Column(name = "byte_image_required_alice_content_type")
    ...
    @Lob
    @Column(name = "byte_any_required_alice")
    private byte[] byteAnyRequiredAlice;

    @Column(name = "byte_any_required_alice_content_type")
    ...
    @Lob
    @Column(name = "byte_text_required_alice")
