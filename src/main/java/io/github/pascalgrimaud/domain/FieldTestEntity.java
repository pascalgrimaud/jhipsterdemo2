...
public class FieldTestEntity implements Serializable {
    ...
    @Lob
    @Column(name = "byte_image_required_tom")
    private byte[] byteImageRequiredTom;

    @Column(name = "byte_image_required_tom_content_type")
    ...
    @Lob
    @Column(name = "byte_any_required_tom")
    private byte[] byteAnyRequiredTom;

    @Column(name = "byte_any_required_tom_content_type")
    ...
    @Lob
    @Column(name = "byte_text_required_tom")
