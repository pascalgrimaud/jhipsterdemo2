...
public class FieldTestServiceImplEntity implements Serializable {
    ...
    @Lob
    @Column(name = "byte_image_required_mika")
    private byte[] byteImageRequiredMika;

    @Column(name = "byte_image_required_mika_content_type")
    ...
    @Lob
    @Column(name = "byte_any_required_mika")
    private byte[] byteAnyRequiredMika;

    @Column(name = "byte_any_required_mika_content_type")
    ...
    @Lob
    @Column(name = "byte_text_required_mika")
