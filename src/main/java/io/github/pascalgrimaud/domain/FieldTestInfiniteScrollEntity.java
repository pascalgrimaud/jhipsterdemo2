...
public class FieldTestInfiniteScrollEntity implements Serializable {
    ...
    @Lob
    @Column(name = "byte_image_required_hugo")
    private byte[] byteImageRequiredHugo;

    @Column(name = "byte_image_required_hugo_content_type")
    ...
    @Lob
    @Column(name = "byte_any_required_hugo")
    private byte[] byteAnyRequiredHugo;

    @Column(name = "byte_any_required_hugo_content_type")
    ...
    @Lob
    @Column(name = "byte_text_required_hugo")
