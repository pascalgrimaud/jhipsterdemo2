...
public class FieldTestMapstructEntity implements Serializable {
    ...
    @Lob
    @Column(name = "byte_image_required_eva")
    private byte[] byteImageRequiredEva;

    @Column(name = "byte_image_required_eva_content_type")
    ...
    @Lob
    @Column(name = "byte_any_required_eva")
    private byte[] byteAnyRequiredEva;

    @Column(name = "byte_any_required_eva_content_type")
    ...
    @Lob
    @Column(name = "byte_text_required_eva")
