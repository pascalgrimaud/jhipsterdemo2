...
public class FieldTestPagerEntity implements Serializable {
    ...
    @Lob
    @Column(name = "byte_image_required_jade")
    private byte[] byteImageRequiredJade;

    @Column(name = "byte_image_required_jade_content_type")
    ...
    @Lob
    @Column(name = "byte_any_required_jade")
    private byte[] byteAnyRequiredJade;

    @Column(name = "byte_any_required_jade_content_type")
    ...
    @Lob
    @Column(name = "byte_text_required_jade")
