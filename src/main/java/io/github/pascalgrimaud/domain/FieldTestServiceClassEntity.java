...
public class FieldTestServiceClassEntity implements Serializable {
    ...
    @Lob
    @Column(name = "byte_image_required_bob")
    private byte[] byteImageRequiredBob;

    @Column(name = "byte_image_required_bob_content_type")
    ...
    @Lob
    @Column(name = "byte_any_required_bob")
    private byte[] byteAnyRequiredBob;

    @Column(name = "byte_any_required_bob_content_type")
    ...
    @Lob
    @Column(name = "byte_text_required_bob")
