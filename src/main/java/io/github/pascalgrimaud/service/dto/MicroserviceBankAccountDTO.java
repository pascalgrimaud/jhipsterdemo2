...
/**
 * A DTO for the MicroserviceBankAccount entity.
 */
public class MicroserviceBankAccountDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MicroserviceBankAccountDTO microserviceBankAccountDTO = (MicroserviceBankAccountDTO) o;
        if (microserviceBankAccountDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), microserviceBankAccountDTO.getId());
    }
    ...
    public String toString() {
        return "MicroserviceBankAccountDTO{" +
            "id=" + getId() +
            ", name='" + getName() + "'" +
