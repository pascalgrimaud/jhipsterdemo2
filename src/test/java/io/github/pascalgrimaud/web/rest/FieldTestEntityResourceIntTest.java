...
public class FieldTestEntityResourceIntTest {
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MINBYTES_TOM = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MAXBYTES_TOM = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MINBYTES_TOM = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MAXBYTES_TOM = TestUtil.createByteArray(2, "1");
