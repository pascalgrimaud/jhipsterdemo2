...
public class FieldTestPagerEntityResourceIntTest {
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MINBYTES_JADE = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MAXBYTES_JADE = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MINBYTES_JADE = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MAXBYTES_JADE = TestUtil.createByteArray(2, "1");
