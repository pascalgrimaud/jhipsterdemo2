...
public class FieldTestPaginationEntityResourceIntTest {
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MINBYTES_ALICE = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MAXBYTES_ALICE = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MINBYTES_ALICE = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MAXBYTES_ALICE = TestUtil.createByteArray(2, "1");
