...
public class FieldTestServiceImplEntityResourceIntTest {
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MINBYTES_MIKA = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_IMAGE_MAXBYTES_MIKA = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MINBYTES_MIKA = TestUtil.createByteArray(2, "1");
    ...
    private static final byte[] UPDATED_BYTE_ANY_MAXBYTES_MIKA = TestUtil.createByteArray(2, "1");
